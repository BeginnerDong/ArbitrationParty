<template>
	<view class="container">
		<view class="tip-container formLis">
			...
			<view class="rightBox">
				<textarea v-model="submitData.content" type="text" placeholder="请输入您的文字说明" placeholder-style="color:#999999;font-size:22rpx;" />
			</view>
		</view>
		...
		<view class="img-container formLis">
			...
			<view class="rightBox">
				<view class="text-container">
					...
					<view><p style="color: red; font-weight: bold;">(可上传多张)</p></view>
				</view>
				<view>
