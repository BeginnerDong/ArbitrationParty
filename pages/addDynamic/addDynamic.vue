<template>
	<view class="container">
		...
		<view class="tip-container">
			...
			<textarea v-model="submitData.content" type="text" placeholder="请输入您的文字说明" placeholder-style="color:#999999;font-size:11px;" />
		</view>
	   
	   
	<view class="img-container">
	  <view class="title">图片文档</view>
	  <image @click="upload" src="../../static/images/form-icon3.png"/>
